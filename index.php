  ...
  <main class="content">
    <section class="container" style="margin: 90px auto">
      ...
      <div class="row">
        <div class="col s12">
          <ul class="tabs">
            <li class="tab col s3"><a class="active" href="#test1">Insert Data</a></li>
            <li class="tab col s3"><a href="#test2">View Data</a></li>
          </ul>
        </div>
        <div id="test1" class="col s12"><?php content() ?></div>
        <div id="test2" class="col s12">
          <section class="row">
            <div class="col sm12">
              <?php include "load-data.php" ?>
            </div>
          </section>
        </div>
      </div>
